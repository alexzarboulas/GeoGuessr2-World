"""
Trains a ResNet-50 model on a single hierarchy level (L3).
...
def main():
    ...
    torch.save(dataset.label_map, "label_map_L3.pth")
    ...
    torch.save(model.state_dict(), "../../models/hierarchy_L3.pth")
    print("Training complete, model saved to ../../models/hierarchy_L3.pth")
