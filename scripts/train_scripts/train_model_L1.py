"""
Trains a ResNet-50 model on a single hierarchy level (L1).
...
def main():
    ...
    torch.save(dataset.label_map, "label_map_L1.pth")
    ...
    torch.save(model.state_dict(), "../../models/hierarchy_L1.pth")
    print("Training complete, model saved to ../../models/hierarchy_L1.pth")
