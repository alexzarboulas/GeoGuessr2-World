...
def main():
    ...
    torch.save(dataset.label_map, "label_map_L8.pth")
    ...
    torch.save(model.state_dict(), "../../models/hierarchy_L8.pth")
    print("Training complete, model saved to ../../models/hierarchy_L8.pth")
